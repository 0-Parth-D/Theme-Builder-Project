...
<?php $this->renderPartial('_form', array('model'=>$model, 'formList'=>$formList, 'formFieldsList'=>$formFieldsList,  'formClassList'=>$formClassList, 'htmlTagList'=>$htmlTagList,'modelId' => $modelId, 'update'=>true)); ?>
